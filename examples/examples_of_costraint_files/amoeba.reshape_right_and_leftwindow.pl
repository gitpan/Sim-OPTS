...
$x_wall_base_right =  (  $v[4][0] - $v[1][0] )  ; # YOU CAN MAKE THIS MORE GENERAL
$y_wall_base_right = (  $v[4][1] - $v[1][1] )  ; # YOU CAN MAKE THIS MORE GENERAL
$z_wall_height_right =  ( $v[8][2] - $v[4][2]) ; # YOU CAN MAKE THIS MORE GENERAL
$x_wall_base_left =  (  $v[3][0] - $v[2][0] )  ; # YOU CAN MAKE THIS MORE GENERAL
$y_wall_base_left = (  $v[3][1] - $v[2][1] )  ; # YOU CAN MAKE THIS MORE GENERAL
$z_wall_height_left =  ( $v[6][2] - $v[2][2]) ; # YOU CAN MAKE THIS MORE GENERAL

$x_base_centre_right = (( abs( $v[4][0] - $v[1][0])  / 2 ) +  min( $v[4][0], $v[1][0] ) ); # YOU CAN MAKE THIS MORE GENERAL
$y_base_centre_right = ( ( abs(  $v[4][1] - $v[1][1] ) / 2 ) + min( $v[4][1], $v[1][1] ) ); # YOU CAN MAKE THIS MORE GENERAL
$height_centre_right = ( ( abs( $v[8][2] - $v[4][2]) / 2 ) +  $v[4][2] ); # YOU CAN MAKE THIS MORE GENERAL
$x_base_centre_left = (( abs( $v[2][0] - $v[3][0])  / 2 ) +  min( $v[2][0], $v[3][0] ) ); # YOU CAN MAKE THIS MORE GENERAL
$y_base_centre_left = ( ( abs(  $v[2][1] - $v[3][1] ) / 2 ) + min( $v[2][1], $v[3][1] ) ); # YOU CAN MAKE THIS MORE GENERAL
$height_centre_left = ( ( abs( $v[6][2] - $v[2][2]) / 2 ) +  $v[2][2] ); # YOU CAN MAKE THIS MORE GENERAL
...
$v[23][0] = $window_x_1_right; 
$v[24][0] = $window_x_2_right;
$v[25][0] = $window_x_2_right;
$v[26][0] = $window_x_1_right;
$v[23][1] = $window_y_1_right; 
$v[24][1] = $window_y_2_right;
$v[25][1] = $window_y_2_right;
$v[26][1] = $window_y_1_right;
$v[23][2] = $window_z_1_right;
$v[24][2] = $window_z_1_right;
$v[25][2] = $window_z_2_right;
$v[26][2] = $window_z_2_right;
...
$v[15][0] = $window_x_2_left; 
$v[16][0] = $window_x_1_left;
$v[17][0] = $window_x_1_left;
$v[18][0] = $window_x_2_left;
$v[15][1] = $window_y_2_left; 
$v[16][1] = $window_y_1_left;
$v[17][1] = $window_y_1_left;
$v[18][1] = $window_y_2_left;
$v[15][2] = $window_z_1_left;
$v[16][2] = $window_z_1_left;
$v[17][2] = $window_z_2_left;
$v[18][2] = $window_z_2_left;
