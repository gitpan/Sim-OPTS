...
@dowhat = ( "y", # 1) Create cases for simulation; 
"y", # 2) simulate AND retrieve
"y", # 3) retrieve data
...
@simtitle = ("mar31"); # write here the name of the time periods will be taken into account in the simulations.
@reportperiods = ("mar31"); # write here the name of the time periods will be taken into account in the reports.
...
@retrievedataloads = ("1 3 1", "31 3 24", "1"); # start data to retrieve for loads; end data to retrieve for loads.
@retrievedatatempsstats = ("1 3 1", "31 3 24", "1"); # start data to retrieve for temps; end data to retrieve for temps.
