# This Makefile is for the Sim::OPTS extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Sim/OPTS.pm]
#     AUTHOR => [q[Gian Luca Brunetti <gianluca.brunetti@polimi.it>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Sim::OPTS]
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Sim/OPTS.pm]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Sim/OPTS.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Sim
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Sim
...
TO_INST_PM = lib/Sim/OPTS.pm

PM_TO_BLIB = lib/Sim/OPTS.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Sim/OPTS.pm $(INST_MAN3DIR)/Sim::OPTS.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Gian Luca Brunetti <gianluca.brunetti@polimi.it>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Sim-OPTS' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "Gian Luca Brunetti <gianluca.brunetti@polimi.it>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Sim-OPTS",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Gian Luca Brunetti &lt;gianluca.brunetti@polimi.it&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Sim/OPTS.pm blib/lib/Sim/OPTS.pm 
