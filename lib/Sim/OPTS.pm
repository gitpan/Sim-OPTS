...
OPTS is a program I have written as a side project since 2008, where I was beginning to learn to program. Due to that, the most fundamental parts of it are the ones that are written in the strangest manner. As you may realize by looking at the code, anyway, I am not a professional programmer and do several things in a non-standard way.

I wrote the program in my spare time. The only parte of it I wrote for work is that the file "opts_launch.pl", which was needed for the inclusion of the use of OPTS in an institutional research I was carrying on in 2011-2012.
